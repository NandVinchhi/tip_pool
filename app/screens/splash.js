...
export default class Splash extends React.Component  {
  ...
  render(){
    ...
    <View style={styles.container}>
      ...
      <Text style={{position:'relative',fontSize:15,margin:'auto', textAlign:'center', color:'#2D3748', fontFamily:'Gadugi', marginTop:'2%'}} onPress={()=>this.props.navigation.navigate('Scan')}>If you're a customer tap here </Text>
    </View>
    );
    }
    else {
